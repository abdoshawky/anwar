            ...
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-header">
                        Store normal category
                        <a class="pull-left btn btn-sm" download href="{!! url('json/categories.json') !!}">Download</a>
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{!! url('/categories/normal') !!}">
                            {!! csrf_field() !!}
            ...
            <table class="table">
                ...
                @foreach($categories as $category)
                    <tr>
                        ...
                        <td>{!! $category->name !!}</td>
                        <td>
                            <form method="post" action="{!! url('categories/'.$category->id.'/normal') !!}" style="display: inline-block">
                                {!! csrf_field() !!}
                                {!! method_field('delete') !!}
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <form method="POST" action="{!! url('/categories/'.$category->id.'/normal') !!}">
                                        {!! csrf_field() !!}
                                        {!! method_field('put') !!}
