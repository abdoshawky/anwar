            ...
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-header">
                        Store upnormal data
                        <a class="pull-left btn btn-sm" download href="{!! url('json/dataUpnormal.json') !!}">Download</a>
                    </div>

                    <div class="card-body">
                        <form method="POST" action="{!! url('/data/upnormal') !!}">
                            {!! csrf_field() !!}
            ...
            <table class="table">
                ...
                @foreach($data as $item)
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{!! url('data/'.$item->id.'/upnormal') !!}">
                                {!! csrf_field() !!}
                                {!! method_field('delete') !!}
